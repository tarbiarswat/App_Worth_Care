...
import com.worthcare.bmicalculator.BmiCustomViewPager;
...
//        });
        ...
        getSupportActionBar().setCustomView(R.layout.bmi_abs_layout);
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (isFirstStart) {
                    ...
                    //  Launch app intro
                    Intent intro = new Intent(BmiMainActivity.this, BmiIntroActivity.class);
                    startActivity(intro);
...
//        Intent intent = new Intent(BmiMainActivity.this, BmiIntroActivity.class);
//        startActivity(intent);

        // Setup the viewPager
        BmiCustomViewPager viewPager = (BmiCustomViewPager) findViewById(R.id.view_pager);
    ...
    private class BmiPagerAdapter extends FragmentPagerAdapter {
        ...
        public View getTabView(int position) {
            ...
            View view = LayoutInflater.from(BmiMainActivity.this).inflate(R.layout.bmi_bottom_tab, null);
        ...
        public Fragment getItem(int pos) {
            switch (pos) {
                ...
                case 1:
                    return BmiHistoryTabFragment.newInstance(2);
                case 2:
                    return BmiSettingsTabFragment.newInstance(3);
