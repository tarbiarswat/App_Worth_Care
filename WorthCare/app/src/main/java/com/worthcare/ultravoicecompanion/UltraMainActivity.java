package com.worthcare.ultravoicecompanion;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(UltraMainActivity.this,
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(UltraMainActivity.this,
                            Manifest.permission.RECORD_AUDIO)) {
                        ...
                        ActivityCompat.requestPermissions(UltraMainActivity.this,
...
//        Fourth: Open a browser and open url
        ...
        tts = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (tts.getEngines().size() == 0 ){
                    Toast.makeText(UltraMainActivity.this, getString(R.string.tts_no_engines),Toast.LENGTH_LONG).show();
                    finish();
                } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main_ultra, menu);
        return true;
    }
